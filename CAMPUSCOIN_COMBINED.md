# Campus Coin — Combined Review File

A single concatenated document holding the three text files requested, plus a reference to the
review bundle archive (a binary ZIP cannot be embedded in a text file — see Part 4).

Generated from the **current working tree**; every part is reproduced verbatim. Nothing was
reformatted, re-indented, re-wrapped or edited.

| | |
|---|---|
| Repository | `/Users/a1234/Documents/Codex/2026-09-16/clo/outputs/campus-coin` |
| Branch | `main` |
| HEAD | `a71f9849e6492aaaf7b75803c417abb9eb0cae2a` |
| Generated | 2026-09-25 |

## Contents

| Part | Source file | Size | Lines | SHA-256 |
|---|---|---|---|---|
| Part 1 | `docs/api/authentication.md` | 27,357 B | 607 | `26be7d479cad20bdb0af9c5751906cf190cb02ab7f23e8c96dfc4139d93ad095` |
| Part 2 | `db/05_seed.sql` | 10,790 B | 180 | `0f7ac95416aefb5e323f3703970e64927a3466346256199c47b714b8fc88a299` |
| Part 3 | `db/merged/campuscoin_full.sql` | 173,550 B | 3,640 | `3fce888a1239b8f9a8809b3cbf18e54eb6ce0191b8735796757da790228ad074` |
| Part 4 | `CAMPUSCOIN_SECURITY_M11_REVIEW_BUNDLE.zip` (binary, not embedded) | 1,376,202 B | — | `31d45da34a9a01a88fb06892065103a7f5f3bb2e544e8e1c25dc11f01b2cc46b` |

---

## Part 1 — `docs/api/authentication.md`

> Verbatim contents · 27,357 bytes · 607 lines · SHA-256 `26be7d479cad20bdb0af9c5751906cf190cb02ab7f23e8c96dfc4139d93ad095`
...
| Requirement | Status |
|-------------|--------|
| UC-04 Profile, UC-27 Preferences | Module 2, not started |
| All other UCs | Modules 3–12, not started |
...
## Part 2 — `db/05_seed.sql`

> Verbatim contents · 10,790 bytes · 180 lines · SHA-256 `0f7ac95416aefb5e323f3703970e64927a3466346256199c47b714b8fc88a299`
...
## Part 3 — `db/merged/campuscoin_full.sql`

> Verbatim contents · 173,550 bytes · 3,640 lines · SHA-256 `3fce888a1239b8f9a8809b3cbf18e54eb6ce0191b8735796757da790228ad074`
...
## Part 4 — `CAMPUSCOIN_SECURITY_M11_REVIEW_BUNDLE.zip`

This part is a **binary ZIP archive** and cannot be embedded inside this Markdown file. It sits
alongside this document at the repository root:

```
CAMPUSCOIN_SECURITY_M11_REVIEW_BUNDLE.zip
```

| | |
|---|---|
| Path | `/Users/a1234/Documents/Codex/2026-09-16/clo/outputs/campus-coin/CAMPUSCOIN_SECURITY_M11_REVIEW_BUNDLE.zip` |
| Size | 1,376,202 bytes |
| SHA-256 | `31d45da34a9a01a88fb06892065103a7f5f3bb2e544e8e1c25dc11f01b2cc46b` |
| Contents | 280 files + `REVIEW_MANIFEST.md`, under `CAMPUSCOIN_SECURITY_M11_REVIEW_BUNDLE/` |

The bundle's own `REVIEW_MANIFEST.md` documents each file it contains, its SHA-256, why it was
included, and which files were deliberately excluded.

> **Note on duplication.** All three files above are *also* present inside the ZIP at these same
> relative paths (`docs/api/authentication.md`, `db/05_seed.sql`, `db/merged/campuscoin_full.sql`),
> because the bundle is a working-tree snapshot. Parts 1–3 are reproduced here for convenience, so
> this document is self-contained.

Verify the ZIP with:

```bash
unzip -t CAMPUSCOIN_SECURITY_M11_REVIEW_BUNDLE.zip && shasum -a 256 CAMPUSCOIN_SECURITY_M11_REVIEW_BUNDLE.zip
```
